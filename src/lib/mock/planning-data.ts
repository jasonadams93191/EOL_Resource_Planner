  ...
  epics: [
    {
      ...
      workItems: [
        workItem('pwi-intake360-001', 'Discovery workshop and requirements gathering', 'pe-intake360-discovery', {
          ...
          domainTag: 'litify',
          urgency: 'normal',
          manualOverrides: [{ field: 'estimatedHours', originalValue: 0.5, overriddenValue: 0.4, note: 'Adjusted based on PM availability for this sprint' }],
        }),
...
export const mockDocRetrievalProject: PlanningProject = {
  ...
  epics: [
    {
      ...
      notes: 'Completed Mar 2025. Started Mar 5, finished Mar 9.',
      workItems: [
  ...
  sourceRefs: [{ sourceType: 'manual', label: 'Manual stub — no Jira project yet' }],
  notes: 'Completed Mar 2025. Jason Adams — 30h actual. Started Mar 5, finished Mar 9.',
}
